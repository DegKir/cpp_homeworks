...
Warrior* KnightFactory::createWarrior()
{
    return new Knight;
}
KnightFactory::~KnightFactory(){}

Warrior* ArcherFactory::createWarrior()
{
    return new Archer;
}
ArcherFactory::~ArcherFactory(){}

Warrior* MageFactory::createWarrior(Spell* spell)
{
    return new Mage(spell);
}

Warrior* MageFactory::createWarrior()
{
    return new Mage();
}
